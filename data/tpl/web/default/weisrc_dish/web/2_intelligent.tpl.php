    ...
    <div class="panel panel-default">
        ...
        <table class="table table-hover">
            ...
            <tr>
                ...
                <th style="width:8%;text-align:center;">适用人数</th>
                <th style="width:72%;text-align:center;">商品</th>
            ...
            <tr>
                <td align="center"><input type="text" class="form-control" name="displayorder[<?php  echo $row['id'];?>]" value="<?php  echo $row['displayorder'];?>"></td>
