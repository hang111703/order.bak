            ...
            <form action="" method="post" class="form-horizontal form" enctype="multipart/form-data">
                <table class="table table-hover table-bordered">
                    ...
                    <tr>
                        ...
                        <?php  } ?>
                        <th style="width:15%;text-align: center;">门店名称</th>
                        <th style="width:12%;text-align: center;">门店类型</th>
                        <th style="width:18%;text-align: center;">订餐类型</th>
                        <th style="width:18%;text-align: center;">快捷管理</th>
                        <th style="width:10%;text-align: center;">生成链接</th>
