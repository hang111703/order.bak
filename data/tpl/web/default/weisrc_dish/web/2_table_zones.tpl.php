            ...
            <form action="" method="post" class="form-horizontal form" enctype="multipart/form-data">
                <table class="table table-hover">
                    ...
                    <tr>
                        ...
                        <th style="width:14%;">名字</th>
                        <th style="width:10%;">服务费</th>
                        <th style="width:10%;">最低消费</th>
                        <th style="width:12%;">预订预付款</th>
                        <th style="width:10%;">桌子数量</th>
                        <th style="width:16%;">所属门店</th>
                    ...
                    <tr>
                        ...
                        <td align="right">
                            <?php  echo $item['limit_price'];?>.00
                        </td>
                        <td align="right">
                            <?php  echo $item['reservation_price'];?>.00
                        </td>
                        <td align="right">
