<?php defined('IN_IA') or exit('Access Denied');?><div class="form-group">
    ...
    <div class="col-sm-7">
        <div class="input-group">
            ...
            <input type="text" class="form-control" value="0" name="begindistance[]">
            <span class="input-group-addon no-b">公里至</span>
            <input type="text" class="form-control" value="0" name="enddistance[]">
            <span class="input-group-addon no-b">公里,配送费</span>
            <input type="text" class="form-control" value="0" name="dispatchprice[]">
