        ...
        <form action="" method="post" class="form-horizontal form" >
            ...
            <table class="table table-hover">
                ...
                <tr>
                    ...
                    <th style="width:10%;">(ID)姓名</th>
                    <th style="width:15%;">手机号码</th>
                    <th style="width:24%;">配送点</th>
                    <th style="width:12%;">可提现金额</th>
                ...
                <tr>
                    ...
                    <td align='center'>
                        ...
                        <?php  } else { ?>
                        <img src="<?php  echo tomedia('../addons/weisrc_dish/template/images/default-headimg.jpg');?>" style="width:30px;height:30px;padding1px;border:1px solid #ccc"/>
                        <?php  } ?>
                    </td>
                    <td>
                        (<?php  echo $row['id'];?>)<?php  if(!empty($row['username'])) { ?><?php  echo $row['username'];?><?php  } else { ?>------<?php  } ?>
                    </td>
                    <td align="center"><?php  if(!empty($row['mobile'])) { ?><?php  echo $row['mobile'];?><?php  } else { ?>------<?php  } ?></td>
                    <td><?php  echo $row['areaname'];?></td>
                    <td align="right">
                        <span class="label label-success"><?php  echo $row['delivery_price'];?></span>
                    </td>
                    <td align="center"><?php  if($row['status']==2) { ?><span class="label label-success">启用</span><?php  } else { ?><span class="label label-danger">禁止</span><?php  } ?></td>
