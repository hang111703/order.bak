            ...
            <div class="table-responsive panel-body">
                <table class="table table-hover">
                    ...
                    <tr>
                        ...
                        <th style="width:16%;text-align: center;">昵称</th>
                        <th style="width:12%;text-align: center;">顾客姓名</th>
                        <th style="width:14%;text-align: center;">手机号码</th>
                        <th style="width:10%;text-align: center;">下单数量</th>
                        <th style="width:12%;text-align: center;">消费金额</th>
                    ...
                    <tr>
                        ...
                        <td class="text-center"><?php  if(empty($item['mobile'])) { ?>-------<?php  } else { ?><?php  echo $item['mobile'];?><?php  } ?></td>
                        <td class="text-right">
