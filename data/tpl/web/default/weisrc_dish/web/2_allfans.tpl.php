            ...
            <div class="table-responsive panel-body">
                <table class="table table-hover">
                    ...
                    <tr>
                        ...
                        <th style="width:6%;text-align: center;">头像</th>
                        <th style="width:12%;text-align: center;">昵称</th>
                        <th style="width:10%;text-align: center;">姓名/手机</th>
                        <th style="width:12%;text-align: center;">佣金</th>
                        <th style="width:8%;text-align: center;">下单数</th>
                        <th style="width:10%;text-align: center;">消费金额</th>
                        <th style="width:12%;text-align: center;">余额/积分</th>
                    ...
                    <tr>
                        <td>
                            ...
                            <img src= <?php  if(isset($item['agentheadimgurl']) && $item['agentheadimgurl'] != '') { ?> "<?php  echo tomedia($item['agentheadimgurl']);?>" <?php  } else { ?> "<?php  echo tomedia('../addons/weisrc_dish/template/images/default-headimg.jpg');?>" <?php  } ?>  style="width:30px;height:30px;padding1px;border:1px solid #ccc"/>
                        ...
                        <td style="white-space:normal;">
                            <img src= <?php  if(isset($item['headimgurl']) && $item['headimgurl'] != '') { ?> "<?php  echo tomedia($item['headimgurl']);?>" <?php  } else { ?> "<?php  echo tomedia('../addons/weisrc_dish/template/images/default-headimg.jpg');?>" <?php  } ?> style="width:30px;height:30px;padding1px;border:1px solid #ccc"/>
                        </td>
                        <td style="white-space:normal;">
                        ...
                        <td class="text-right">
                            <span class="label label-info">推广:<?php  if(empty($item['commission_price'])) { ?>0.00<?php  } else { ?><?php  echo $item['commission_price'];?><?php  } ?></span><br>
                            <span class="label label-default">配送:<?php  if(empty($item['delivery_price'])) { ?>0<?php  } else { ?><?php  echo $item['delivery_price'];?><?php  } ?></span>
                        </td>
                        <td class="text-right">
