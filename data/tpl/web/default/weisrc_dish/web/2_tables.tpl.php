            ...
            <form action="" method="post" class="form-horizontal form" >
                ...
                <div class="table-responsive panel-body">
                    <table class="table table-hover">
                        ...
                        <tr>
                            <td class="with-checkbox"><input type="checkbox" name="check" value="<?php  echo $row['id'];?>" checked="checked"></td>
                            <td>
                                <?php  echo $row['id'];?>
                            </td>
                            <td>
                            ...
                            <td align="center">
                                <a href="<?php  echo $this->createWebUrl('fans', array('id' => $row['fansid'], 'storeid' => $storeid,  'op' => 'post'))?>">
                                    <img src=<?php  if(isset($row['headimgurl']) && $row['headimgurl'] != '') { ?> "<?php  echo tomedia($row['headimgurl']);?>" <?php  } else { ?> "<?php  echo tomedia('../addons/weisrc_dish/template/images/default-headimg.jpg');?>" <?php  } ?>  style="width:30px;height:30px;padding:1px;border:1px solid #ccc"/>
                                </a>
                            </td>
                            <td>
                                <a href="<?php  echo $this->createWebUrl('fans', array('id' => $row['fansid'], 'storeid' => $storeid, 'op' => 'post'))?>">
                            ...
                            <td style="text-align:left;">
                                <a class="btn btn-default btn-sm" href="<?php  echo $this->createWebUrl('allorder', array('op' => 'detail', 'id' => $row['id'], 'storeid' => $storeid))?>" title="详情">详情</a>
                                ...
                                <a class="btn btn-danger btn-sm" href="<?php  echo $this->createWebUrl('allorder', array('op' => 'refund', 'id' => $row['id'], 'storeid' => $storeid))?>" title="退款" onclick="return confirm('此操作不可恢复，确认退款？');return false;">退款</a>
                                <?php  } ?>
                                <?php  } ?>
                            </td>
                        </tr>
