            ...
            <form action="" method="post" class="form-horizontal form" enctype="multipart/form-data">
                <table class="table table-hover">
                    ...
                    <tr>
                        ...
                        <th style="width:10%;">提现费率</th>
                        <th style="width:15%;">最低提现</th>
                        <th style="width:10%;">手续费最低</th>
                    ...
                    <tr>
                        ...
                        <td align="right">
                            <?php  if($item['is_default_rate']==1) { ?>
                            <?php  echo $setting['getcash_price'];?>.00
                            <?php  } else { ?>
                            <?php  echo $item['getcash_price'];?>.00
                            <?php  } ?>
                        </td>
                        <td align="right">
                            <?php  if($item['is_default_rate']==1) { ?>
                            <?php  echo $setting['fee_min'];?>.00
                            <?php  } else { ?>
                            <?php  echo $item['fee_min'];?>.00
                            <?php  } ?>
                        </td>
                        <td align="right">
                            <?php  if($item['is_default_rate']==1) { ?>
                            <?php  echo $setting['fee_max'];?>.00
                            <?php  } else { ?>
                            <?php  echo $item['fee_max'];?>.00
                            <?php  } ?>
                        </td>
