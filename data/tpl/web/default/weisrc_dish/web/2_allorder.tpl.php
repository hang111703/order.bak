                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-7 col-lg-2 col-xs-12">
                        <select name="dining_mode" class="form-control">
                            <option value="">不限</option>
                            <option value="1" <?php  if($_GPC['dining_mode'] == 1) { ?> selected="selected" <?php  } ?>>店内</option>
                ...
                <table class="table  table-bordered">
                    <thead class="navbar-inner">
                        <tr>
                            ...
                            <th style="width:8%;text-align: center;">订单总额</th>
                            <th style="width:20%;text-align: center;">联系信息</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="font-weight:bold;text-align: right;">
                                <span class="label label-warning" >￥<?php  echo $item['totalprice'];?></span>
                            </td>
                            <td>
                            ...
                            <td style="text-align:left;">
                                ...
                                <?php  if($item['paytype'] != 4 && $item['paytype'] != 9 ) { ?>
...
<script type="text/javascript">
    $(function () {
        $(".check_all").click(function () {
            ...
            //以下语句有错误，只能执行一次，第二次就不执行了 -2018/06/26
