            ...
            <form action="" method="post" class="form-horizontal form" enctype="multipart/form-data">
                ...
                <table class="table table-hover">
                    ...
                    <tr>
                        ...
                        <th style="width:8%;text-align:center;">顺序</th>
                        ...
                        <th style="width:8%;text-align:center;">打包费</th>
                        <th style="width:8%;text-align:center;">赠积分</th>
                        <th style="width:8%;text-align:center;">库存数</th>
                        <th style="width:7%;text-align:center;">总销量</th>
                        <th style="width:10%;text-align:center;">是否上架</th>
                    ...
                    <tr>
                        ...
                        <td align='center'>
                            <img src="<?php  echo tomedia($item['thumb']);?>" width="50" onerror="this.src='./resource/images/nopic.jpg';" style="border-radius: 3px;" />
                        </td>
                        <td>
                            <?php  echo $item['title'];?>
                        </td>
                        <td align='right'>
                            ...
                            <br/>
                            <span class="label label-info">会员:<?php  echo $item['memberprice'];?></span>
                            <?php  } ?>
                        </td>
                        <td align='right'>
                        ...
                        <td align='right'>
                            ...
                            <?php  } else { ?>
                            <span class="label label-danger">剩余:<?php  echo $item['counts']-$item['today_counts']?></span>
                            <?php  } ?>
                            <br/>
                            <?php  if($item['counts']==-1) { ?>
                            <span class="label label-default">未启用</span>
                            <?php  } else { ?>
                            <span class="label label-info">每日:<?php  echo $item['counts'];?></span>
                            <?php  } ?>
                        </td>
                        <td align='right'>
                            <?php  echo $item['sales'];?>
                        </td>
                        <td align='center'><?php  if($item['status']) { ?><span class="label label-success">已上架</span><?php  } else { ?><span class="label label-danger">已下架</span><?php  } ?></td>
