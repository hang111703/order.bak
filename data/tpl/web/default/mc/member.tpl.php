...
<form method="post" class="we7-form" id="form1">
			<table class="table we7-table table-hover vertical-middle">
				...
				<tr>
					...
					<th class="text-center">昵称/真实姓名</th>
					<th class="text-center">手机</th>
					<th class="text-center">邮箱</th>
					<th class="text-center">余额/积分</th>
				...
				<tr>
					...
					<td class="text-right"><?php  echo $li['uid'];?></td>
					<td>
						<?php  if($li['nickname']) { ?><?php  echo $li['nickname'];?><?php  } else { ?><span class="label label-warning">未完善</span><?php  } ?>
						<br>
						<?php  if($li['realname']) { ?><?php  echo $li['realname'];?><?php  } else { ?><span class="label label-warning">未完善</span><?php  } ?>
					</td>
					<td class="text-center"><?php  if($li['mobile']) { ?><?php  echo $li['mobile'];?><?php  } else { ?>未完善<?php  } ?></td>
