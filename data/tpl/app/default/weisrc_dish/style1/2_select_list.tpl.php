...
<div class="center">
	...
	<footer class="footFix">
		...
		<a class="btn_change" href="<?php  echo $this->createMobileUrl('wapselectlist', array('storeid' => $storeid, 'from_user' => $from_user, 'num' => $num, 'intelligentid' => $intelligentid, 'mode' => $mode, 'tablesid' => $tablesid), true)?>" onclick="showDish()">更换套餐</a>
	</footer>
</div>
