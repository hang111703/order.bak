...
<head>
    ...
    <title>欢迎光临<?php  echo $setting['title'];?></title>
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <a href="<?php  if(empty($item['url'])) { ?>#<?php  } else { ?><?php  echo $item['url'];?><?php  } ?>" style="line-height: 0px;">
                            <img onerror="this.src='<?php echo RES;?>/themes/images/nopic.jpeg'" width="100%"  data-src="<?php  echo tomedia($item['thumb'])?>" class="swiper-lazy"/>
                        </a>
                    </div>
                    <?php  } } ?>
                </div>
