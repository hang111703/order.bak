...
" . ($pindex - 1) * $psize . ',' . $psize, array(':weid' => $this->_weid));
    ...
    if (checksubmit('submit')) {
        ...
        //根据目前对业务和软件的了解，配送员不属于店家而是某个公众号的，上面的语句应该修改为下面的。2018-05-18
//        message('操作成功！', $this->createWebUrl('delivery', array('op' => 'display', 'weid' => $this->_weid), true));
    }
    ...
    //根据目前对业务和软件的了解，配送员不属于店家而是某个公众号的，上面的语句应该修改为下面的。2018-05-18
//    message('删除成功！', $this->createWebUrl('delivery', array('op' => 'display', 'weid' => $this->_weid)), 'success');
